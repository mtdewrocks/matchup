...
matchup_tab = html.Div(
    [dbc.Row([html.Div(html.H1("MLB Matchup Analysis", id="title", style={"textAlign":"center"}), className="row"),
...
#tabs = dbc.Container([dbc.Row([dbc.Col(dbc.Tabs([dcc.Tab(matchup_tab,label="Pitcher Matchup"),
#                 dcc.Tab(placeholder_tab, label="Placeholder")]))])])

#tabs_take_two = html.Div([dcc.Tabs(matchup_tab,placeholder_tab)])
...
app_tabs = html.Div(
        [
                dbc.Tabs(
                    [
        dbc.Tab(label="Pitcher Matchups", tab_id="pitchers-matchup-tab"),
        dbc.Tab(label="Placeholder", tab_id="placeholder-tab"),
        ],
        id="tabs", active_tab="pitchers-matchup-tab",),],)

##app.layout = dbc.Container([
##    dbc.Row(dbc.Col(html.H1("MLB Dashboard and Tools", style={"textAlign": "center"}), width=12)), dbc.Row(dbc.Col(app_tabs, width=12), className="mb=3"),
...
tabs = dbc.Tabs([dbc.Tab(dummy_tab, label="Dummy"), dbc.Tab(matchup_tab, label="Matchup")])
