...
hot_hitter_tab = dbc.Container([dbc.Row([html.Img(
            id="fire", src=app.get_asset_url("https://github.com/mtdewrocks/matchup/raw/main/assets/fire.jpg"), alt="fire", height=25, width=25, style={'display':'block', 'padding':'0px', 'padding-left':"0px"}),
